...
export default function AnimatedThemeToggle() {
  ...
  return (
    <div aria-label="Animated theme toggle" className="relative" style={{ transform: "scale(0.28)", transformOrigin: "right center" }}>
      <input
        type="checkbox"
        id="ravonoThemeToggle"
        ...
        <div className="body">
          <div className="phone">
            ...
            <div className="content">
              ...
              <label htmlFor="ravonoThemeToggle" aria-hidden="true">
